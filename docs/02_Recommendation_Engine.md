...
Recommendation Engine использует накопленную историю обучения для оценки уровня освоения материала, определения тем, требующих повторения, и автоматического формирования персонализированных рекомендаций.
...
- Recommendation Engine анализирует только те паттерны, которые уже присутствуют в словаре (`dictionary`). Темы, отсутствующие в словаре, не могут быть рекомендованы, даже если они относятся к предметной области.
...
- использование независимой Knowledge Map для анализа полноты изучения предметной области и формирования рекомендаций по новым темам;
